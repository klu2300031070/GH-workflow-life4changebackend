...
public class HospitalController {
    ...
    public ResponseEntity<Boolean> checkUsername(@PathVariable String username) {
        try {
            ...
            return ResponseEntity.ok(hospital != null);
        } catch (Exception e) {
            return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(false);
        }
    }
    @GetMapping("/checkhospitalusername/{username}")
    public ResponseEntity<Boolean> checkHospitalUsername(@PathVariable String username) {
        Hospital exists = hospitalRepository.findByUsername(username);
        return ResponseEntity.ok(exists!=null);
    }
    // ✅ Register hospital
